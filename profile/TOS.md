...
This Terms of Service Agreement (the "Agreement") is entered into between [General Tromboni, oYazan] ("Bot Owners") and the user ("User") of the [Axis] Discord bot (the "Bot").
...
4. Modifications to the Bot: The Bot Owners may modify or discontinue the Bot at any time without notice. The User agrees that the Bot Owner shall not be liable to the User or any third party for any modification, suspension, or discontinuance of the Bot.
